  ...
  return (
    <div id="wd-lab1">
      ...
      <ol id="wd-your-favorite-recipe">
        <li>Add carrot, onion into the pan after pouring oil.</li>
        <li>Fry it for some time</li>
        <li>Add the rice.</li>
        <li>Put the Hapima Masala.</li>
        <li>Cook it for some time.</li>
        <li>Fried Rice is ready.</li>
      </ol>
