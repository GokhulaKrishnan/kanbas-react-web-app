  ...
  return (
    <div>
      ...
      <div id="wd-modules-buttons">
        ...
        <select id="wd-select-one-modules">
          <option selected value="Publish All">
            Publish All
          </option>
          <option value="Np">Not Publish</option>
        </select>
      ...
      <ul id="wd-modules">
        <li className="wd-module">
          <div className="wd-title">
            Week 1, Lecture - Course Introduction, Syllabus, Agenda
          </div>
          ...
          <ul className="wd-lessons">
            <li className="wd-lesson">
              ...
              <ul className="wd-content">
                ...
                <li className="wd-content-item">
                  Formatting web content with Listsand Tables
                </li>
              </ul>
            </li>
          </ul>
